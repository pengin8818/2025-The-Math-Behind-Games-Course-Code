...
class LunarLander:
    ...
    def __init__(self, fuel, start_position_x, start_position_y, start_position_z):
        self.fuel = fuel
        self.position = [start_position_x, start_position_y, start_position_z]
        self.orientation = [
                            [1, 0, 0],
                            [0, 1, 0],
                            [0, 0, 1]
    ...
    def thrust(self):
        ...
        if self.fuel > 0:
            self.fuel -= 1
            thrust_direction = matrix_multiply(self.orientation, [[0,0,1]])
            thrust_vector = matrix_multiply([[self.thrust_power], [self.thrust_power], [self.thrust_power]], thrust_direction)
    ...
    def rotate(self, x,y,z):
        self.orientation = matrix_multiply(x)
        self.orientation = matrix_multiply(y)
        self.orientation = matrix_multiply(z)
...
def add_vectors(vector1: list, vector2: list) -> list:
    ...
    for index in range(len(vector1)):
        output_vector.append([vector1[index][0] + vector2[index][0]])
...
def matrix_multiply(matrix_a: list, matrix_b: list) -> list:
    ...
    # edit the values of this matrix and return it at the end of the function!
    result = [[0,0,0],
              [0,0,0],
              [0,0,0]]
...
def x_rotation(angle) -> list:
    ...
    return [
    [1, 0, 0],
    [0, numpy.cos(rad_degree), -numpy.sin(rad_degree)],
    [0, numpy.sin(rad_degree), numpy.cos(rad_degree)]
    ]
...
def y_rotation(angle):
    ...
    return [
    [numpy.cos(radDegree), 0, numpy.sin(radDegree)],
    [0, 1, 0],
    [-numpy.sin(radDegree), 0, numpy.cos(radDegree)]
    ]
